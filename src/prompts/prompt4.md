...
2. Classify each sentence against the 9 ISO 25010:2023 main quality characteristics (and only the main characteristics).
3. A single sentence MAY map to more than one characteristic if it addresses multiple quality concerns.  
  
## ISO 25010:2023 — The 9 Main Characteristics & Sub-Characteristics  
...
- Map to sub-characteristics when the sentence specifically addresses them; use main characteristic only when the sub-characteristic is unclear.
