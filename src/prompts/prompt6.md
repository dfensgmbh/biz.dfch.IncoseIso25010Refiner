...
5. Ignore any line that start with a hash character ("#") or a double forward-slash character ("//"). These lines can give you context, but are not part of the requirement set.
